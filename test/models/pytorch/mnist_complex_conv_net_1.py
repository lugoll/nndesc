...
model = nn.Sequential(
    ...
    nn.Sigmoid(),
    nn.Conv2d(16, 16, kernel_size=(3, 3), padding=1, stride=(2, 2)),
    nn.Sigmoid(),
...
if __name__ == "__main__":
    ...
    onnx.export(net, x, 'pytorch/saved_models/my_complex_cnn_1.onnx', export_params=True, opset_version=13, training=onnx.TrainingMode.EVAL)
